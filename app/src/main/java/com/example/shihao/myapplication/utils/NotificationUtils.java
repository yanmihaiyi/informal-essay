...
import com.example.shihao.myapplication.MyActivity;
...
public class NotificationUtils extends ContextWrapper {
    ...
    private NotificationCompat.Builder getNotification(String title, String content) {
        Intent intentOne = new Intent(mContext, MyActivity.class);
        PendingIntent pendingIntentOne = PendingIntent.getActivity(mContext, 0, intentOne, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        builder.setContentIntent(pendingIntentOne);
        //设置点击信息后自动清除通知
